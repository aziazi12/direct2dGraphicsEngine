...
// Draws the entire image. Can edit an change the amount of how much you need
// Can create different functions for doing so, such as 50% or something like that
// This is also the function that you call using spritesheet variable to draw the image
